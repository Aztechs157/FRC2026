...
/**
 * Contains 3D mechanism offset constants for Sunstone V2 
 * and methods to animate the AdvantageScope CAD model.
 */
public class SunstoneV2Mechanism3D extends SubsystemBase {
    ...
    /** Initializes the 3D mechanisms for SunstoneV2, and specifies the mechanisms to extract poses from. */
    ...
    /** 
     * 3D offsets from the robot's origin (center of rotation, roughly equivalent to the location of the Pigeon)
     * to various key points on the robot, used for ballistic calculations and mechanism visualization on the AdvantageScope model.
     */
    public class Mechanism3DConstants {
        ...
        /**
         * 2D offset from the robot's origin to the turret base, 
         * used in position-based dynamic shooting calculations.
         */
   ...
   */
     ...
     * 
     * @return a {@link Pose3d} containing the position of the hopper walls relative to the robot origin
     */
     ...
     * 
     * @return a {@link Pose3d} array containing the poses of the turret, hood, slapdown, and hopper walls.
     */
