...
/** Represents an implementation of the Hood running on TalonFX-based motors (e.g. a Kraken X44). */
    ...
    public HoodIOTalonFX(SubsystemBase subsystem) {
        ...
        SmartMotorControllerConfig hoodMotorConfig =
                new SmartMotorControllerConfig(subsystem)
                        ...
                        .withSoftLimit(
                                HoodConstants.LOWER_SOFT_LIMIT, HoodConstants.UPPER_SOFT_LIMIT)
        ...
        SmartMotorController smartHoodMotor =
                new TalonFXWrapper(talonfx, DCMotor.getKrakenX44(1), hoodMotorConfig);
        ...
        PivotConfig hoodConfig =
                new PivotConfig(smartHoodMotor)
                        ...
                        .withHardLimit(
                                HoodConstants.LOWER_HARD_LIMIT, HoodConstants.UPPER_HARD_LIMIT)
