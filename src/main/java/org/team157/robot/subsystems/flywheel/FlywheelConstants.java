...
public final class FlywheelConstants {
  ...
  public static final double KP = 1.0, KI = 0.0, KD = 0.0;
  public static final double KS = 0.0, KV = 0.37, KA = 0.31;
  public static final double SIM_KP = 1.57, SIM_KI = 0, SIM_KD = 0.157;
  public static final double SIM_KS = 0.0,
      SIM_KV = 0.37,
      SIM_KA = 0.25; // Determined via Reca.lc, tune and/or run
  ...
  public static final AngularAcceleration ANGULAR_ACCELERATION =
      RotationsPerSecondPerSecond.of(6000);
