...
/**
 * Represents an implementation of the Flywheel running on TalonFX-based motors (e.g. Kraken X60).
 */
    ...
    public FlywheelIOTalonFX(SubsystemBase subsystem) {
        ...
        SmartMotorControllerConfig flywheelMotorConfig =
                new SmartMotorControllerConfig(subsystem)
                        ...
                        .withSimFeedforward(
                                new SimpleMotorFeedforward(
                                        FlywheelConstants.SIM_KS,
                                        FlywheelConstants.SIM_KV,
                                        FlywheelConstants.SIM_KA))
        ...
        SmartMotorController smartMotor =
                new TalonFXWrapper(talonFX, DCMotor.getKrakenX60(1), flywheelMotorConfig);
