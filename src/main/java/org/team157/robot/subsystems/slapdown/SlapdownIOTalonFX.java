...
public class SlapdownIOTalonFX implements SlapdownIO {
    ...
    private double mapEncoder(double min, double max){
        return PosUtils.mapRange(encoder.get(), SlapdownConstants.MIN_ENCODER_POSITION, 
                    SlapdownConstants.MAX_ENCODER_POSITION, min, max);
    }
    ...
    public void updateInputs(SlapdownIOInputs inputs) {
        ...
        inputs.angleFromEncoderDegrees = mapEncoder(SlapdownConstants.MIN_ANGLE, SlapdownConstants.MAX_ANGLE);
