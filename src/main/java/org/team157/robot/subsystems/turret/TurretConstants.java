...
public final class TurretConstants {
    ...
    public static final Angle LOWER_SOFT_LIMIT = Degrees.of(-178),
            UPPER_SOFT_LIMIT = Degrees.of(171);
    public static final Angle LOWER_HARD_LIMIT = Degrees.of(-178),
            UPPER_HARD_LIMIT = Degrees.of(171);
    // Angle offset to account for misalignment between turret zero position and robot forward, in
    // degrees.
