...
public class PositionDetails {
  ...
  public class Location {
    ...
    /**
     * Constructs a Location object from a given set of XYZ coordinates, parsed from the JSON file.
     * The x and y coordinates are used to create a Pose2d for targeting, while the z coordinate is
     * stored separately for height information.
     *
     ...
     *
     * @return The Pose2d of the location, with the x and y coordinates from the JSON file, and a
     *     blank rotation.
     */
  ...
  /**
   * The Zone class represents a rectangular area on the field defined by minimum and maximum x and
   * y coordinates.
   */
  public class Zone {
     ...
     *
     * @param zoneJSON A JsonNode containing the coordinate values for the zone, used to construct
     *     the Rectangle2d representing the zone.
     */
    public Zone(JsonNode zoneJSON) {
      ...
      this.rectangle =
          new Rectangle2d(
              new Translation2d(this.xMin, this.yMin), new Translation2d(this.xMax, this.yMax));
    }
