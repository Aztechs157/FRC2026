 ...
 * various important locations on the field, such as shooting targets and alliance zones. <br>
 * It provides methods to retrieve the appropriate target location for shooting based on the robot's
 * current position and alliance color, as well as checking if the robot is under a trench.
 */
public class PositionDetails {
    /**
     * Location of the JSON file containting position information, placed inside the deploy
     * directory.
     */
    ...
    // TODO: Consider changing names of passing locations to not include the word 'zone' to avoid
    // confusion with the actual passing zones defined as rectangles.
    /**
     * Location representing an arbitrary point in the lower half of the blue alliance's passing
     * zone.
     */
    public Location bluePassingZoneLowLocation;
    /**
     * Location representing an arbitrary point in the upper half of the blue alliance's passing
     * zone.
     */
    public Location bluePassingZoneHighLocation;
    /**
     * Location representing an arbitrary point in the lower half of the red alliance's passing
     * zone.
     */
    public Location redPassingZoneLowLocation;
    /**
     * Location representing an arbitrary point in the upper half of the red alliance's passing
     * zone.
     */
    ...
    public class Location {
        ...
        private double y;
        private double z;
        // The Pose2d representing the location, containing the x and y coordinates and a blank
        // rotation.
        private Pose2d pose;

        /**
         * Constructs a Location object from a given set of XYZ coordinates, parsed from the JSON
         * file. The x and y coordinates are used to create a Pose2d for targeting, while the z
         * coordinate is stored separately for height information.
         *
         * @param locationJSON A JsonNode containing the coordinate values for the location, used to
         *     construct the Pose2d and store the z value.
         */
        ...
        /**
         * Get the Pose2d of the location, which represents the x and y coordinates for targeting.
         *
         * @return The Pose2d of the location, with the x and y coordinates from the JSON file, and
         *     a blank rotation.
         */
        ...
        /**
         * Get the Z coordinate of the location, which represents the height of the shooting target.
         *
    ...
    /**
     * The Zone class represents a rectangular area on the field defined by minimum and maximum x
     * and y coordinates.
     */
    public class Zone {
        ...
        // The Rectangle2d representing the zone, created from the minimum and maximum x and y
        // coordinates.
         ...
         *
         * @param zoneJSON A JsonNode containing the coordinate values for the zone, used to
         *     construct the Rectangle2d representing the zone.
         */
        public Zone(JsonNode zoneJSON) {
            ...
            // Create a Rectangle2d representing the zone, using the minimum and maximum x and y
         ...
         *
         * @return a Rectangle2d, defined by the minimum and maximum x and y coordinates of the
         *     zone.
         */
        // TODO: This method is currently unused, but may be useful for debugging or visualization
         ...
         *
         * @param point A Translation2d representing the point to check for containment within the
         *     zone.
    ...
    public PositionDetails() {
        ...
        try {
            ...
            this.bluePassingZoneHighLocation =
                    new Location(root.get("blue").get("passingZoneHigh"));
    ...
    /**
     * Gets the target Pose2d for the robot to shoot at, based on the robot's current pose and
     * alliance color. Also updates the height variable to the Z value of the target location.
     *
