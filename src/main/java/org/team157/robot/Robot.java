...
public class Robot extends LoggedRobot {
  ...
  public Robot() {
    ...
    // Set the PDH's ID, so that it may be logged.
  ...
  public void robotPeriodic() {
    ...
    Logger.recordOutput("FinalComponentPoses", new Pose3d[] {
      // turret base 
      robotContainer.turret.getBasePose(), 
      // turret hood
      robotContainer.turret.getHoodPivotPose(new Transform3d(0,0,0, 
        new Rotation3d(0, Math.toRadians(robotContainer.hood.getScaledPosAngleSim()), 0))),
      // intake pivot
      robotContainer.slapdown.getIntakePivotPose(), 
      // hopper walls
      robotContainer.slapdown.getHopperWallsPose()} 
    );
    ...
    Logger.recordOutput("Hub Active?", robotContainer.isHubActive());
