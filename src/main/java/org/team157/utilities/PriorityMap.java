...
public final class PriorityMap<K extends Comparable<K>, V> {
     ...
     *     mapping for the key. (A <code>null</code> return can also indicate that the map
    ...
    /**
     * Returns the first value according to the priorities given for each key-value mapping, or
     * <code>
    ...
    /**
     * Returns the last value according to the priorities given for each key-value mapping, or
     * <code>
     * null</code> if the map is empty.
     *
     ...
     * @return the priority to which the specified key is mapped at, or <code>null</code> if this
    ...
    /**
     * Replaces the entry for the specified key only if it is currently mapped to some value, with
     * the same priority as the previous mapping.
     *
     * @param key key with which the specified value is associated
     * @param value value to be associated with the specified key
     * @return the previous value associated with the specified key, or <code>null</code> if there
     *     was no mapping for the key. (A <code>null</code> return can also indicate that the map
