...
1. Download and install [WPILib 2026](https://github.com/wpilibsuite/allwpilib/releases/tag/v2026.1.1), ensuring you select to install VS Code (Note: The WPILib extension on the VS Code Marketplace is unsupported.)
